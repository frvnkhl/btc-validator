 ...
 */
function isSegwitP2SHAddress(address: string): boolean {
 ...
 */
function getBitcoinAddressDetails(address: string): BitcoinAddressDetails {
    const details: BitcoinAddressDetails = {
        address: address,
        isValid: false,
        type: 'unknown',
        network: 'unknown'
